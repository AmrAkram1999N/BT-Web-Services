...
<body>
        ...
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                  ...
                  <li><a class="nav-link scrollto" href="{{ route('Chain.User.Auth.userDashBoard') }}">Dashboard</a></li>
                  @else
                  <li><a class="nav-link scrollto" href="{{ route('Chain.Account.Auth.accountDashboard') }}">Dashboard</a></li>
                  @endif
    ...
    <div style="margin:0; margin-top: 70px; height: 700px;" >
        {{ $slot }}
    </div>
    <!-- ======= Footer ======= -->
    <footer id="footer">
