        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row ">
                ...
                <div class="col-lg-8 mt-5 mt-lg-0">
                    ...
                    <form action="{{ route('login') }}" method="POST" role="form" class="bg-white"
                        style="padding: 20px;">
                        @csrf
                            ...
                            @if (request()->is('Chain/Account/*'))
                                <div class="col-md-6 form-group mt-3 mt-md-0">
                                    ...
                                    <input type="text" class="form-control" name="username"
                                        value="{{ old('username') }}" id="username" placeholder="Your Username"
                                        required autofocus>
                                    @error('username')
                                        <div>
                            ...
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password"
                                        value="{{ old('password') }}" id="password" placeholder="Your Password"
                                        required autofocus>
                                    @error('password')
                                        <div>
                                            <small class="text-danger">
                        ...
                        <div class="text-left"><button class="btn btn-warning" type="submit">Login</button></div>
