    ...
    <div class="row h-100 ">
        ...
        <div class=" col-md-10 w-100" style="background: rgb(255, 255, 255);">
            ...
            <div class="table-responsive text-left">
                    ...
                    <tbody>
                        ...
                        @foreach ($Files as $File)
                            <tr scope="row">
                                <td><input type="checkbox"></td>
                                <td>
                                    <a target="_blank" href="{{ $File->file_path_directory }}" class="ms-1 text-warning"
                ...
                <div>
                    @error('file_request')
                        <small class="text-danger fw-bold text-left" style="font-size: 15px;">
                            {{ $message }}</small>
                    @enderror
                ...
                @if (Session::has('warning'))
                    <div class="alert alert-warning text-black text-left">
                        {{ Session::get('warning') }}
                    </div>
                @endif
            </div>
